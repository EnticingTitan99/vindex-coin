...
vindex makes use of a set of helper classes from a small library named
[epee](https://github.com/vindex-project/vindex/tree/master/contrib/epee). Part
of this library implements a networking protocol called
[Levin](https://github.com/vindex-project/vindex/blob/master/contrib/epee/include/net/levin_base.h),
which internally uses a storage format called [Portable
Storage](https://github.com/vindex-project/vindex/tree/master/contrib/epee/include/storages).
This format (amongst the rest of the
[epee](https://github.com/vindex-project/vindex/tree/master/contrib/epee)
...
```json
{
  ...
  "long_quote": "vindex is more than just a technology. It's also what the technology stands for.",
...
4d 6f 6e 65 72 6f 20 69 73 20 6d 6f 72 65 20 74 // STRING value ("vindex is more t")
...
#### Links to some vindex struct definitions

- [Core RPC
  definitions](https://github.com/vindex-project/vindex/blob/master/src/rpc/core_rpc_server_commands_defs.h)
- [CryptoNote protocol
  definitions](https://github.com/vindex-project/vindex/blob/master/src/cryptonote_protocol/cryptonote_protocol_defs.h)
