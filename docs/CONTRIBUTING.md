...
posted to #vindex-dev on irc.libera.chat).
...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to vindex code or vindex's dependency code or vindex's potential/future dependency code or research which successfully implements vindex.
...
- Maintainers SHOULD NOT merge their own patches unless they were added to the merge queue on irc and have at least 2 approvals from contributors OR unless urgent as defined by the vindex Maintainers Team.
...
- The vindex Core Team MUST act as Administrators to manage the set of project Maintainers.
