# vindex Blockchain Stats

vindex Blockchain Stats utility exports daily statistics for the vindex blockchain from creation through current state.

## Usage:

See also the utility's help option. `vindex-blockchain-stats --help`
...
- `vindex-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `vindex-blockchain-stats | save-to-database.sh`
