...
(define* (make-vindex-cross-toolchain  target
                                       #:key
...
desirable for building vindex release binaries."
          ...
          ((string-contains target "-linux-gnu")
           (list
             ...
             (if (string-contains target "loongarch64")
               (make-vindex-cross-toolchain target #:base-libc glibc)
               (make-vindex-cross-toolchain target))))
