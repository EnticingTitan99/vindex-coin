# Bootstrappable vindex Builds

This directory contains the files necessary to perform bootstrappable vindex 
builds.
...
To build vindex reproducibly with all default options, invoke the
...
repository](https://github.com/vindex-project/guix.sigs).
